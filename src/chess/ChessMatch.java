...
public class ChessMatch {
	...
	private Piece makeMove(Position source, Position target) {
		...
		//#specialMove castling short rook
		...
		// #specialMove castling long rook
		if (p instanceof King && target.getColumn() == source.getColumn() - 2) {
		...
		// #specialMove en passant // p instanceof Pawn && target.getColumn() != source.getColumn() && capturedPiece == null
